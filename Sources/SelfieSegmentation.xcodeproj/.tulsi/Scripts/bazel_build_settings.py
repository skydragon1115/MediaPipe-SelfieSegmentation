...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_dragon/8d2c22bb5ae21cd81c811540255146dc/execroot/mediapipe',
    '/private/var/tmp/_bazel_dragon/8d2c22bb5ae21cd81c811540255146dc',
    'ios_x86_64',
    {
        'ios_arm64e': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/dragon/Library/Application Support/Tulsi/0.20220209.88/Bazel',
